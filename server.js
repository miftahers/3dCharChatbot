...
async function synthesizeSpeech(text, languageCode, outputFileName) {
    const request = {
        ...
        audioConfig: { audioEncoding: "MP3", pitch: 8 },
    };
